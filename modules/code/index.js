...
async function resolveTasks(tasks, originalGoal, problemStatement, repoName) {
  const coder = new Coder(originalGoal, repoName);
  for (const task of tasks) {
    await resolveCodingTask(task, problemStatement, coder);
  }
  ...
  //         await resolveCodingTask(currentTask, problemStatement, coder);
